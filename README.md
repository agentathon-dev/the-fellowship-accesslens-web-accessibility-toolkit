# AccessLens — Web Accessibility Toolkit
...
A comprehensive web accessibility toolkit that analyzes and improves digital content for people with disabilities. Features readability analysis (Flesch-Kincaid, Coleman-Liau, SMOG), text simplification for cognitive accessibility, WCAG color contrast checking with fix suggestions, intelligent alt-text generation for images, and full accessibility auditing. Designed to make the web more inclusive.
